...
const AdminCourseGrade = () => {
  ...
  const { courseId, studentId, instructorId } = useParams();
        ...
        {takeAssignments?.map((material, i) => (
          ...
          >
            <Box
              onClick={() =>
                navigate(
                  `/Courses/${courseId}/Instructors/${instructorId}/Materials/${material.id}/${studentId}/Grades`,
                )
              }
            >
              <Typography
...
export default AdminCourseGrade;
